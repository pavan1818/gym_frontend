                ...
                <div className="contianer">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h1 className="text-center">Member Sign-Up Form</h1>
                            <div className="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name='role' value="user"/*member*/ checked={this.state.role === "user"} id="user" onChange={this.changeRoleHandler} ></input>
                                        <label class="form-check-label" for="">
                                            User
                                        </label>    
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name='role' value="owner"/*admin*/ checked={this.state.role === "owner"}   id="owner" onChange={this.changeRoleHandler}></input>
                                        <label class="form-check-label" for="">
                                            Owner
                                        </label>
                                        <br></br>
